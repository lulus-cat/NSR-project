...
const ITEMS: { key: string; title: string; body: string }[] = [
  ...
  {
    key: "alpha",
    title: "알파 판입니다 — 아직 안 되는 것이 있습니다",
    body:
      "기능이 자주 바뀌고 저장 형식도 바뀔 수 있습니다. 중요한 녹음은 이 앱에만 두지 마세요. " +
      "특히 화자(누가 말했는지)는 자동으로 나뉘지 않습니다 — 기기 안에서 도는 Whisper는 목소리를 " +
      "구별하지 못합니다. 전사 탭에서 구간을 직접 지정하셔야 근무 환경 지표가 나옵니다. " +
      "그리고 전사를 하려면 설정에서 모델을 한 번 받아야 합니다.",
  },
];
